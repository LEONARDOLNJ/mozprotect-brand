...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "MarcaMoç — Registo de marcas em Moçambique" },
      {
        name: "description",
        content:
          "Registe e proteja o nome, logótipo ou slogan da sua marca junto do IPI, a partir de qualquer ponto de Moçambique.",
      },
      { name: "author", content: "MarcaMoç" },
